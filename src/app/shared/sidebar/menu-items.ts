...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Manage', icon: 'mdi mdi-bullseye', class: 'has-arrow', label: '', labelClass: '', extralink: false,
        submenu: [
            { path: '/manage/country', title: 'Country', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
        ]
    },
    {
